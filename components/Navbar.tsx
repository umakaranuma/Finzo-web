  ...
  return (
    <nav className={styles.nav}>
      <Link href="/" className={styles.logo}>
        <div className={styles.logoBox}>
          <svg viewBox="0 0 24 24">
            <path d="M21 7.28V5c0-1.1-.9-2-2-2H5C3.89 3 3 3.9 3 5v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-2.28A2 2 0 0 0 22 15v-4a2 2 0 0 0-1-1.72zM20 15h-5v-4h5v4zM5 19V5h14v2h-6c-1.1 0-2 .9-2 2v4c0 1.1.89 2 2 2h6v4H5z" />
          </svg>
        </div>
      ...
      <div className={styles.right}>
        <a href="https://play.google.com/store" target="_blank" className={styles.navPill}>
          <svg viewBox="0 0 24 24">
